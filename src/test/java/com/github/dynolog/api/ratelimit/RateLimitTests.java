package com.github.dynolog.api.ratelimit;
...
import static com.github.dynolog.api.utils.Constants.RATE_LIMIT.MAX_REQUESTS_PER_MINUTE;
...
public class RateLimitTests {
    ...
    public void should_return_TOO_MANY_REQUESTS_when_number_of_requests_exceeds_the_limit() throws Exception {
        ...
        for (int index = MAX_REQUESTS_PER_MINUTE; index > 0; index--) {
            api.perform(request)
                    .andExpect(header().string("X-Rate-Limit-Remaining", String.valueOf(index - 1)))
